...
tags:
  - Automation
image: /images/writing/2023-01-05/index.webp
---
...
![My Setup]({{ assetPath }}/slack-summary.webp)
...
![Slack Notifications]({{ assetPath }}/zapier-integration.webp)
...
![Slack Notifications]({{ assetPath }}/slack-notifications.webp)
...
![Slack Sidebar]({{ assetPath }}/slack-sidebar.webp)
...
![Slack Section Settings]({{ assetPath }}/slack-section-settings.webp)
